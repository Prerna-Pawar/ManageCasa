...
public final class ActivityUserBinding implements ViewBinding {
  ...
  private ActivityUserBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static ActivityUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserBinding((LinearLayout) rootView, recyclerView);
    }
