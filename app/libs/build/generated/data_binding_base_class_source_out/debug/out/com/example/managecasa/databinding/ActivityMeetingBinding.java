...
public final class ActivityMeetingBinding implements ViewBinding {
  ...
  private ActivityMeetingBinding(@NonNull ScrollView rootView, @NonNull Button button,
      @NonNull EditText editTextDate, @NonNull EditText editTextTextMultiLine,
      @NonNull EditText editTextTime, @NonNull EditText no) {
  ...
  @NonNull
  public static ActivityMeetingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMeetingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_meeting, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMeetingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMeetingBinding((ScrollView) rootView, button, editTextDate,
          editTextTextMultiLine, editTextTime, no);
    }
