...
public final class ItemContainerOnboardingBinding implements ViewBinding {
  ...
  private ItemContainerOnboardingBinding(@NonNull LinearLayout rootView,
      @NonNull ImageView imageOnboarding) {
  ...
  public static ItemContainerOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContainerOnboardingBinding((LinearLayout) rootView, imageOnboarding);
    }
